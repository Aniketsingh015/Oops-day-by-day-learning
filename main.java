 ...
 * ============================================================
 * Demonstrates:
 *   1. Creating Book, Magazine, DVD objects
 *   2. Runtime polymorphism via LibraryItem references
 *   3. getLoanPeriod() returning DIFFERENT values per type
 *   4. Overloaded searchItem() — calling with different argument types
 *   5. A polymorphic ARRAY — the real payoff of Day 4
 */
...
public class main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("========================================");
        System.out.println("  LIBRARY MANAGEMENT SYSTEM — Day 4    ");
        System.out.println("========================================\n");


        // =====================================================
        // PART 1: Creating each type of item
        // =====================================================
        System.out.println("--- PART 1: Creating items ---\n");

        Books book1     = new Books(101, "Clean Code", "Robert C. Martin", "Tech", 3);
        Magazine mag1  = new Magazine(201, "National Geographic", "NatGeo Press", 245, 5);
        DVD dvd1       = new DVD(301, "Inception", "Christopher Nolan", 148, 2);
        ...
        // =====================================================
        // PART 2: Runtime polymorphism — THE key concept
        // =====================================================
        System.out.println("\n--- PART 2: Polymorphic references ---\n");

        // All three are stored as LibraryItem — their common parent type
        // Just like Day 3's Person p = new Student(...)
        LibraryItem item1 = book1;
        LibraryItem item2 = mag1;
        LibraryItem item3 = dvd1;

        // Calling getLoanPeriod() on a LibraryItem reference —
        // but Java runs the ACTUAL object's version at runtime
        System.out.println("item1 (Book) loan period     : " + item1.getLoanPeriod() + " days");
        System.out.println("item2 (Magazine) loan period : " + item2.getLoanPeriod() + " days");
        System.out.println("item3 (DVD) loan period      : " + item3.getLoanPeriod() + " days");
        // Even though all three are typed as LibraryItem, each one
        // returns its OWN number. This is dynamic method dispatch.


        // =====================================================
        // PART 3: The real payoff — an array of mixed types
        // =====================================================
        System.out.println("\n--- PART 3: One array, many types ---\n");

        // Without polymorphism, you couldn't put Book, Magazine, DVD
        // in the same array. With it, they're all "LibraryItem".
        LibraryItem[] allItems = new LibraryItem[] {
            book1,
            mag1,
            dvd1,
            new Books(102, "Harry Potter", "J.K. Rowling", "Fantasy", 4),
            new Magazine(202, "Time Magazine", "Time Inc.", 50, 3)
        };

        // ONE loop, ONE method call — works for every type
        // Java figures out which displayInfo() to run for each object
        ...
        // =====================================================
        // PART 4: Overloaded searchItem() — 3 ways to search
        // =====================================================
        System.out.println("\n--- PART 4: Overloaded search ---\n");

        // Version 1: search by id (int)
        System.out.println("Search book1 by id=101  : " + book1.searchItem(101));
        System.out.println("Search book1 by id=999  : " + book1.searchItem(999));

        // Version 2: search by title (String)
        System.out.println("Search book1 by title 'clean'  : " + book1.searchItem("clean"));
        System.out.println("Search book1 by title 'python' : " + book1.searchItem("python"));

        // Version 3: search by title + author (String, String)
        System.out.println("Search book1 by title+author match : "
                + book1.searchItem("clean", "martin"));
        System.out.println("Search book1 by title+author wrong : "
                + book1.searchItem("clean", "rowling"));

        // Notice: Java picks the right version automatically based on
        // HOW MANY arguments and WHAT TYPES you pass — this decision
        // is made at COMPILE TIME (before the program even runs).
        // That's why overloading = compile-time polymorphism.


        // =====================================================
        // PART 5: Borrowing items polymorphically
        // =====================================================
        System.out.println("\n--- PART 5: Borrow logic works for all types ---\n");
